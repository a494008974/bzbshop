...
if (!$smarty->is_cached('allcate.dwt', $cache_id))
{
    assign_template();
	...
	$smarty->assign('cat_id29_best_goods', index_get_cat_id_goods_best_list(29,8));
	$smarty->assign('cat_id34_best_goods', index_get_cat_id_goods_best_list(34,8));
	
	
	$smarty->assign('cat_id17_best_goods', index_get_cat_id_goods_best_list(17,8));
	$smarty->assign('cat_id116_best_goods', index_get_cat_id_goods_best_list(116,8));
	$smarty->assign('cat_id120_best_goods', index_get_cat_id_goods_best_list(120,8));
...
$smarty->display('allcate.dwt', $cache_id);
