...
if (isset($set_modules) && $set_modules == TRUE)
{
    ...
    $modules[$i]['code']    = 'phpwind5';

    /* 被整合的第三方程序的名称 */
    $modules[$i]['name']    = 'PHPWind';

    /* 被整合的第三方程序的版本 */
    $modules[$i]['version'] = '5.0.1/5.x';
...
class phpwind5 extends integrate
{
    /* 论坛加密密钥 */
    var $db_hash = '';
    ...
    function set_cookie ($username="")
    {
        ...
        $cookie_name = substr(md5($this->db_hash), 0, 5) . '_winduser';
        if (empty($username))
        {
            $time = time() - 3600;
