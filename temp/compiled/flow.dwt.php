...
<div class="block960"  >
 ...
 <div class="heard_flow"> 
  ...
  <div class="step_out"><span class="span1"></span></div>
  <div class="carmsg">正品行货，全国联保，尽享购物乐趣 ！</div>
  
  </div>
  <div class="blank"></div>
  
  <img src="themes/suning/images/my_car.gif" /> 
  ...
  <div class="flowBox">
        ...
        <form id="formCart" name="formCart" method="post" action="flow.php">
           <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table" >
            <tr class="trbg">
              <th align="left" class="carleft" bgcolor="#f6f6f6"><?php echo $this->_var['lang']['goods_name']; ?></th>
      <?php if ($this->_var['show_goods_attribute'] == 1): ?>
              <th align="left" bgcolor="#f6f6f6"><?php echo $this->_var['lang']['goods_attr']; ?></th>
              <?php endif; ?>
              <?php if ($this->_var['show_marketprice']): ?>
              <th align="left" bgcolor="#f6f6f6"><?php echo $this->_var['lang']['market_prices']; ?></th>
              <?php endif; ?>
              <th align="left" bgcolor="#f6f6f6"><?php echo $this->_var['lang']['shop_prices']; ?></th>
              <th align="left"  bgcolor="#f6f6f6"><?php echo $this->_var['lang']['number']; ?></th>
              <th align="left" bgcolor="#f6f6f6"><?php echo $this->_var['lang']['subtotal']; ?></th>
              <th  align="left" bgcolor="#f6f6f6"><?php echo $this->_var['lang']['handle']; ?></th>
            </tr>
            <?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');if (count($_from)):
    foreach ($_from AS $this->_var['goods']):
?>
            <tr class="trline">
              <td bgcolor="#ffffff" class="carleft"  >
                <?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['extension_code'] != 'package_buy'): ?>
                  <?php if ($this->_var['show_goods_thumb'] == 1): ?>
                    <span><a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class="f6"><?php echo $this->_var['goods']['goods_name']; ?></a></span>
                  <?php elseif ($this->_var['show_goods_thumb'] == 2): ?>
                    <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class="proimg "><img style="width:60px" src="<?php echo $this->_var['goods']['goods_thumb']; ?>" border="0" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" /></a>
                  <?php else: ?>
                    <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class="proimg "><img style="width:60px"  src="<?php echo $this->_var['goods']['goods_thumb']; ?>" border="0" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" /></a>
                    <span><a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class="f6"><?php echo $this->_var['goods']['goods_name']; ?></a></span>
                  <?php endif; ?>
...
?>
              ...
              <?php endif; ?>
              <?php if ($this->_var['show_marketprice']): ?>
              <td bgcolor="#ffffff"><?php echo $this->_var['goods']['market_price']; ?></td>
              <?php endif; ?>
              <td  bgcolor="#ffffff"><span class="f1"><?php echo $this->_var['goods']['goods_price']; ?></span></td>
              <td  bgcolor="#ffffff">
              ...
              <td  bgcolor="#ffffff"><span class="f1"><?php echo $this->_var['goods']['subtotal']; ?></span></td>
              <td  bgcolor="#ffffff">
                <a href="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_goods&amp;id=<?php echo $this->_var['goods']['rec_id']; ?>'; "  style="color:#006dc8"><?php echo $this->_var['lang']['drop']; ?></a>
                <?php if ($_SESSION['user_id'] > 0 && $this->_var['goods']['extension_code'] != 'package_buy'): ?>
                <a href="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_to_collect&amp;id=<?php echo $this->_var['goods']['rec_id']; ?>'; "  style="color:#006dc8"><?php echo $this->_var['lang']['drop_to_collect']; ?></a>
                <?php endif; ?>            </td>
            </tr>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          </table>
          <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" >
            <tr>
              <td bgcolor="#ffffff">
               <input type="button" value="<?php echo $this->_var['lang']['clear_cart']; ?>" class="bnt_blue_3" onclick="location.href='flow.php?step=clear'" />
                <input name="submit" type="submit" class="bnt_blue_3" value="<?php echo $this->_var['lang']['update_cart']; ?>" />
              </td>
              <td align="right" bgcolor="#ffffff" class="zongjia ">
        ...
        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" >
          <tr>
            <td bgcolor="#ffffff">&nbsp &nbsp </td>
            <td bgcolor="#ffffff" align="right" class="jxgw"><a  style="color: #006dc8;" href="./"> <<继续购物 </a> <a style="padding: 0px 0 0 20px;" href="flow.php?step=checkout">
			<img style="margin-top:5px;"  src="themes/suning/images/checkout.gif" onmouseover="this.src='themes/suning/images/checkout_hover.gif'" onmouseout="this.src='themes/suning/images/checkout.gif'" /></a></td>
          </tr>
        </table>
  ...
  <img style="float:left" src="themes/suning/images/flow_2_t.gif" />
  
  <div class="flowBox_in2">  
...
?>
   ...
   <img style="float:left" src="themes/suning/images/flow_2_b.gif" />      
        </div>
      <?php endif; ?>
  ...
  <div class="flowBox_in2">  
    <div class="tit"><span><?php echo $this->_var['lang']['goods_fittings']; ?></span></div>
...
?>
			 ...
			 <li>
              <span class="goodsimg">
                ...
                <h4><a href="<?php echo $this->_var['fittings']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['fittings']['goods_name']); ?>" class="f6"><?php echo htmlspecialchars($this->_var['fittings']['short_name']); ?></a></h4>
				<p style="font-family:arial"><em><?php echo $this->_var['fittings']['fittings_price']; ?></em></p> 
          
                <div class="price"><a href="javascript:fittings_to_flow(<?php echo $this->_var['fittings']['goods_id']; ?>,<?php echo $this->_var['fittings']['parent_id']; ?>)">加入购物车</a></div>
            </li>
  ...
  <div class="blank"></div>
   <div class="blank"></div>
    <div class="blank"></div>
	<div style="border-top: 1px solid #96BBD8;margin: 5px auto 30px;width: 960px;">
</div>
  <?php endif; ?>
...
?><br />
            ...
            <tr>
              ...
              <td align="center" bgcolor="#ffffff"><input type="image" src="themes/suning/images/bnt_cat.gif" alt="Add to cart"  border="0" /></td>
            </tr>
            <?php endif; ?>
          </table>
...
?>
  ...
  <div class="blank"></div>
   <div class="flowBox" style="border: 1px solid #d5d5d5;">
        ...
        <div class=" ">
        <h5><span><?php echo $this->_var['lang']['goods_list']; ?></span><?php if ($this->_var['allow_edit_cart']): ?><a href="flow.php" class="f6"><?php echo $this->_var['lang']['modify']; ?></a><?php endif; ?></h5>
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
              <th bgcolor="#f6f6f6"><?php echo $this->_var['lang']['goods_name']; ?></th>
              <th bgcolor="#f6f6f6"><?php echo $this->_var['lang']['goods_attr']; ?></th>
              <?php if ($this->_var['show_marketprice']): ?>
              <th bgcolor="#f6f6f6"><?php echo $this->_var['lang']['market_prices']; ?></th>
              <?php endif; ?>
              <th bgcolor="#f6f6f6"><?php if ($this->_var['gb_deposit']): ?><?php echo $this->_var['lang']['deposit']; ?><?php else: ?><?php echo $this->_var['lang']['shop_prices']; ?><?php endif; ?></th>
              <th bgcolor="#f6f6f6"><?php echo $this->_var['lang']['number']; ?></th>
              <th bgcolor="#f6f6f6"><?php echo $this->_var['lang']['subtotal']; ?></th>
            </tr>
            <?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');if (count($_from)):
    foreach ($_from AS $this->_var['goods']):
?>
...
?>
      ...
      <div class="blank"></div>
      <div class=" ">
      <h5><span><?php echo $this->_var['lang']['consignee_info']; ?></span><a href="flow.php?step=consignee" class="f6"><?php echo $this->_var['lang']['modify']; ?></a></h5>
      <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
              <td bgcolor="#f6f6f6"><?php echo $this->_var['lang']['consignee_name']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['consignee']); ?></td>
              <td bgcolor="#f6f6f6"><?php echo $this->_var['lang']['email_address']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['email']); ?></td>
            </tr>
            <?php if ($this->_var['total']['real_goods_count'] > 0): ?>
            <tr>
              <td bgcolor="#f6f6f6"><?php echo $this->_var['lang']['detailed_address']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['address']); ?> </td>
              <td bgcolor="#f6f6f6"><?php echo $this->_var['lang']['postalcode']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['zipcode']); ?></td>
            </tr>
            <?php endif; ?>
            <tr>
              <td bgcolor="#f6f6f6"><?php echo $this->_var['lang']['phone']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo $this->_var['consignee']['tel']; ?> </td>
              <td bgcolor="#f6f6f6"><?php echo $this->_var['lang']['backup_phone']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['mobile']); ?></td>
            </tr>
             <?php if ($this->_var['total']['real_goods_count'] > 0): ?>
            <tr>
              <td bgcolor="#f6f6f6"><?php echo $this->_var['lang']['sign_building']; ?>:</td>
              <td bgcolor="#ffffff"><?php echo htmlspecialchars($this->_var['consignee']['sign_building']); ?> </td>
              <td bgcolor="#f6f6f6"><?php echo $this->_var['lang']['deliver_goods_time']; ?>:</td>
    ...
    <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd" id="shippingTable">
            <tr>
              <th bgcolor="#f6f6f6" width="5%">&nbsp;</th>
              <th bgcolor="#f6f6f6" width="25%"><?php echo $this->_var['lang']['name']; ?></th>
              <th bgcolor="#f6f6f6"><?php echo $this->_var['lang']['describe']; ?></th>
              <th bgcolor="#f6f6f6" width="15%"><?php echo $this->_var['lang']['fee']; ?></th>
              <th bgcolor="#f6f6f6" width="15%"><?php echo $this->_var['lang']['free_money']; ?></th>
              <th bgcolor="#f6f6f6" width="15%"><?php echo $this->_var['lang']['insure_fee']; ?></th>
            </tr>
...
?>
    ...
    <div class=" ">
    <h5><span><?php echo $this->_var['lang']['payment_method']; ?></span></h5>
    <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd" id="paymentTable">
            <tr>
              <th width="5%" bgcolor="#f6f6f6">&nbsp;</th>
              <th width="20%" bgcolor="#f6f6f6"><?php echo $this->_var['lang']['name']; ?></th>
              <th bgcolor="#f6f6f6"><?php echo $this->_var['lang']['describe']; ?></th>
              <th bgcolor="#f6f6f6" width="15%"><?php echo $this->_var['lang']['pay_fee']; ?></th>
            </tr>
...
?>
    ...
    <div class="blank"></div>
          ...
          <div class=" ">
          <h5><span><?php echo $this->_var['lang']['goods_package']; ?></span></h5>
          <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd" id="packTable">
            <tr>
              <th width="5%" scope="col" bgcolor="#f6f6f6">&nbsp;</th>
              <th width="35%" scope="col" bgcolor="#f6f6f6"><?php echo $this->_var['lang']['name']; ?></th>
              <th width="22%" scope="col" bgcolor="#f6f6f6"><?php echo $this->_var['lang']['price']; ?></th>
              <th width="22%" scope="col" bgcolor="#f6f6f6"><?php echo $this->_var['lang']['free_money']; ?></th>
              <th scope="col" bgcolor="#f6f6f6"><?php echo $this->_var['lang']['img']; ?></th>
            </tr>
            <tr>
...
?>
          ...
          <div class=" ">
          <h5><span><?php echo $this->_var['lang']['goods_card']; ?></span></h5>
          <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd" id="cardTable">
            <tr>
              <th bgcolor="#f6f6f6" width="5%" scope="col">&nbsp;</th>
              <th bgcolor="#f6f6f6" width="35%" scope="col"><?php echo $this->_var['lang']['name']; ?></th>
              <th bgcolor="#f6f6f6" width="22%" scope="col"><?php echo $this->_var['lang']['price']; ?></th>
              <th bgcolor="#f6f6f6" width="22%" scope="col"><?php echo $this->_var['lang']['free_money']; ?></th>
              <th bgcolor="#f6f6f6" scope="col"><?php echo $this->_var['lang']['img']; ?></th>
            </tr>
            <tr>
...
?>
    ...
    <h5><span><?php echo $this->_var['lang']['other_info']; ?></span></h5>
      <table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            ...
            <tr>
              <td width="20%"  bgcolor="#f6f6f6"><strong><?php echo $this->_var['lang']['use_surplus']; ?>: </strong></td>
            ...
            <tr>
              <td   bgcolor="#f6f6f6"><strong><?php echo $this->_var['lang']['use_integral']; ?></strong></td>
            ...
            <tr>
              <td bgcolor="#f6f6f6"><strong><?php echo $this->_var['lang']['use_bonus']; ?>:</strong></td>
              <td bgcolor="#ffffff">
...
?>
            ...
            <tr>
              <td   bgcolor="#f6f6f6"><strong><?php echo $this->_var['lang']['invoice']; ?>:</strong>
            ...
            <?php endif; ?>
            <tr>
              <td valign="top"   bgcolor="#f6f6f6"><strong><?php echo $this->_var['lang']['order_postscript']; ?>:</strong></td>
            ...
            <tr>
              <td   bgcolor="#f6f6f6"><strong><?php echo $this->_var['lang']['booking_process']; ?>:</strong></td>
    ...
    <h5><span><?php echo $this->_var['lang']['fee_total']; ?></span></h5>
          <?php echo $this->fetch('library/order_total.lbi'); ?>
           <div align="center" style="margin:8px auto;">
            <input type="image" src="themes/suning/images/bnt_subOrder.gif" />
...
<div class="flowBox">
         <h6 style="text-align:center;  "><?php echo $this->_var['lang']['remember_order_number']; ?>: <font style="color:red"><?php echo $this->_var['order']['order_sn']; ?></font></h6>
  ...
  <div class="blank"></div>
        ...
        <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr>
            ...
            <h6 style="background:#f6f6f6"><span>用户登录：</span></h6>
            <form action="flow.php?step=login" method="post" name="loginForm" id="loginForm" onsubmit="return checkLoginForm(this)">
                <table width="90%" border="0" cellpadding="8" cellspacing="0" bgcolor="#B0D8FF" >
                  <tr>
            ...
            <td valign="top" bgcolor="#ffffff">
             <h6 style="background:#f6f6f6"><span>用户注册：</span></h6>
            <form action="flow.php?step=login" method="post" name="formUser" id="registerForm" onsubmit="return checkSignupForm(this)">
               <table width="98%" border="0" cellpadding="8" cellspacing="0" bgcolor="#B0D8FF" >
                  <tr>
